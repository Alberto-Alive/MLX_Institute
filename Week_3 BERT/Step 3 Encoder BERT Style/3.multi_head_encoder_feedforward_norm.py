...
class Magic(torch.nn.Module):
    def __init__(self,  embedding_dim, num_heads):
        ...
        self.W_Q = torch.nn.Linear(self.embedding_dim, self.embedding_dim) # project embedding sequence on query
        self.W_K = torch.nn.Linear(self.embedding_dim, self.embedding_dim) # project embedding sequence on query keys
        self.W_V = torch.nn.Linear(self.embedding_dim, self.embedding_dim) # project embedding sequence on query values
        self.W_O = torch.nn.Linear(self.embedding_dim, self.embedding_dim) # project concatenated head outputs
