...
# Example input
input_word = "revolution"  # Word you want to check the context for
...
if input_word in words_to_ids:
    ...
    print("Predicted context words: ", predicted_context_words)
    print(f"Input word: {input_word} has french and whilst")
    print("Predicted context words: ", {ids_to_words["152"], ids_to_words["104"]})
else:
