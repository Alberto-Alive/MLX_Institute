...
model_save_path = "./models/cpu_w2v_text8_v4.pth"
...
# Example input
input_word = "originated"  # Word you want to check the context for
...
if input_word in words_to_ids:
    ...
    print("Predicted context words: ", {ids_to_words["2"], ids_to_words["3"]})
else:
